...
export default function AddQuestions({setAddInteraction, name, question, setQuestion, setQuestions}){
    ...
    return(
        ...
        {  afterLaunch ? <p className="launch-note">Participants are joining</p>:
               <>
                   ...
                   <button disabled={disabled} onClick={()=>{setAfterlaunch(true), addQuestions() }}>Launch</button>
                   </div> 
                   </div> }
        </>
    )
